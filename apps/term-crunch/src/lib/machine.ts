...
/**
 * term-crunch is single-machine. Every pane/leaf carries this id, and the
 * command pipeline runs every command against this one machine.
 */
export const CRUNCH_MACHINE: MachineId = "crunch";
...
export const GIT_AUTHOR = "player <player@crunch.local>";
