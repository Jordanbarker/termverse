...
export const CHALLENGES: Challenge[] = [panesSplit, panesGrid, panesCleanup, windowsCreate, gitFirstCommit, gitStashChallenge, gitPullFf, gitRebaseChallenge, rmBomb, chmodPerms, copyModeYank];
