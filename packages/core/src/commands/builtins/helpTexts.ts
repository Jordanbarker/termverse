export const HELP_TEXTS: Record<string, string> = {
  ...
  git: [
    ...
    "  git clone [-b <branch>] <url>  Clone a remote repository",
    "  git add <file|.|-A>         Stage changes for commit",
    "  git commit [-a] [--amend] -m 'msg'  Record changes to the repository",
    "  git status [-s]             Show the working tree status",
    "  git log [--oneline] [--graph]  Show commit history",
    "  git branch [-a|-r] [<name>|-d|-D <name>] List, create, or delete branches",
    ...
    "  git stash [push|pop|list] [-u]  Stash working changes",
  ].join("\n"),
